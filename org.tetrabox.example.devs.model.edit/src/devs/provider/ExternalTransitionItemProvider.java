 ...
 * @generated
 */
public class ExternalTransitionItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ExternalTransition_inPort_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ExternalTransition_inPort_feature", "_UI_ExternalTransition_type"),
				 DevsPackage.Literals.EXTERNAL_TRANSITION__IN_PORT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addSourceStatePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ExternalTransition_sourceState_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ExternalTransition_sourceState_feature", "_UI_ExternalTransition_type"),
				 DevsPackage.Literals.EXTERNAL_TRANSITION__SOURCE_STATE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addTargetStatePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ExternalTransition_targetState_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ExternalTransition_targetState_feature", "_UI_ExternalTransition_type"),
				 DevsPackage.Literals.EXTERNAL_TRANSITION__TARGET_STATE,
				 true,
				 false,
				 true,
				 null,
