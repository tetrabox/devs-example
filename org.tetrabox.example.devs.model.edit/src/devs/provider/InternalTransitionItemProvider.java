 ...
 * @generated
 */
public class InternalTransitionItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_InternalTransition_sourceState_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_InternalTransition_sourceState_feature", "_UI_InternalTransition_type"),
				 DevsPackage.Literals.INTERNAL_TRANSITION__SOURCE_STATE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addTargetStatePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_InternalTransition_targetState_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_InternalTransition_targetState_feature", "_UI_InternalTransition_type"),
				 DevsPackage.Literals.INTERNAL_TRANSITION__TARGET_STATE,
				 true,
				 false,
				 true,
				 null,
