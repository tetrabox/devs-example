...
/**
 * This is the item provider adapter for a {@link devs.Lambda} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Lambda_state_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Lambda_state_feature", "_UI_Lambda_type"),
				 DevsPackage.Literals.LAMBDA__STATE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addOutPortPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Lambda_outPort_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Lambda_outPort_feature", "_UI_Lambda_type"),
				 DevsPackage.Literals.LAMBDA__OUT_PORT,
				 true,
				 false,
				 true,
				 null,
