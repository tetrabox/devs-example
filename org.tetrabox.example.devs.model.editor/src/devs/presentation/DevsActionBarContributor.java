...
/**
 * This is the action bar contributor for the Devs model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DevsActionBarContributor
	 ...
	 * @generated
	 */
	public DevsActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("devs-settings"));
		toolBarManager.add(new Separator("devs-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(ModelEditorPlugin.INSTANCE.getString("_UI_DevsEditor_menu"), "devsMenuID");
